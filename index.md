...
Note: Ruby `Logger` objects also support debug-level logs. We advise that you do not enable debug level logging in production, but, if you do, `progstr-ruby` will accept those events too.
